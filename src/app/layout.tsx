...
import { AppCustomizationProvider } from '@/context/app-customization-context'; // Import the provider
...
export const metadata: Metadata = {
  title: 'Tiny Scholars Hub', // This title can also be made dynamic later if needed
  ...
  return (
    <html lang="en">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} font-sans antialiased`}>
        <AppCustomizationProvider> {/* Wrap with the provider */}
          {children}
          <Toaster />
          <PWALoader /> 
