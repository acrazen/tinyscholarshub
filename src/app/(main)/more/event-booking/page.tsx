...
import { CalendarPlus, Construction, ArrowLeft } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-12rem)] py-8">
      <Card className="w-full max-w-md shadow-xl rounded-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Event Booking</CardTitle>
          <CardDescription>Book school events, parent-teacher meetings, and more.</CardDescription>
        </CardHeader>
